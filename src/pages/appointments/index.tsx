...
export function AppointmentListPage(props: AppointmentListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getAppointments({
        relations: ['user_appointment_healthcare_provider_idTouser', 'user_appointment_guest_idTouser'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'user_appointment_healthcare_provider_idTouser',
          header: 'User Appointment Healthcare Provider Id Touser',
          accessorKey: 'user_appointment_healthcare_provider_idTouser',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/users/view/${record.user_appointment_healthcare_provider_idTouser?.id}`}
            >
              {record.user_appointment_healthcare_provider_idTouser?.email}
            </Link>
          ),
        }
      : null,
