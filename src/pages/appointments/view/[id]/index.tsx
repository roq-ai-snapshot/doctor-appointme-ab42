            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="User Appointment Healthcare Provider Id Touser"
                    text={
                      <Link
                        as={NextLink}
                        href={`/users/view/${data?.user_appointment_healthcare_provider_idTouser?.id}`}
                      >
                        {data?.user_appointment_healthcare_provider_idTouser?.email}
                      </Link>
                    }
                  />
                )}
