  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Doctor Appointment System - Streamlining your health journey with efficient, easy, and personalized scheduling for all your medical needs."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkb2N0b3J8ZW58MHx8fHwxNjkzNTU2MzY4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Doctor Appointment System - Streamlining your health journey with efficient, easy, and personalized scheduling for all your medical needs.`}
            </Text>
            <Box
